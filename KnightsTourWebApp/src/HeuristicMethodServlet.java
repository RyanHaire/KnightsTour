...
/**
 * Servlet implementation class HeuristicMethodServlet
 */
@WebServlet("/HeuristicMethodServlet")
public class HeuristicMethodServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public HeuristicMethodServlet() {
		super();
	}
